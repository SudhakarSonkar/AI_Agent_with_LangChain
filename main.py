...
- If the user asks to add a task, call the Todoist tool. 
- If the user asks to view existing tasks, fetch them from Todoist and show them in a clear, concise list. 
- Keep responses short, relevant, and user-friendly (no unnecessary details or links).
"""
